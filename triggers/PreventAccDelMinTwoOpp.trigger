trigger PreventAccDelMinTwoOpp on Account (before delete) {
    ...
    if(trigger.isBefore){
        ...
        accList = [SELECT id, name, Total_Opportunities__c, (SELECT id, name FROM Opportunities) FROM Account WHERE id =: accIds ];
